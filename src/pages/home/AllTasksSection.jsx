    ...
    return (
      <div style={{width:"100%"}}>
        ...
        <section className="flex all-tasks mt">
          {value.docs.length === 0 && (
            <h2>
              {i18n.language===("ar")&&"أضف مهام جديدة من خلال الزر الذي في الاسفل"}
              {i18n.language===("en")&&"Add new tasks through the button below"}
              {i18n.language===("fr")&&"Ajoutez de nouvelles tâches via le bouton ci-dessous"}
            </h2>
          )}
